...
class MultiDropDown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<String> availableMainCategories = controller.listingCardData
        .map((e) => e.mainFeatures)
        .toSet()
        .toList();
    List<String> availableSubMainCategories = controller.listingCardData
        .map((e) => e.mainSubCategories)
        .toSet()
        .toList();
    List<String> allSports = controller.listingCardData
        .map((e) => e.allSprots)
        .toSet()
        .toList();
