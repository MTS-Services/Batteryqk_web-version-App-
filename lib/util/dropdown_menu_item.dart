class DropDownMenuItem {
  ...
  static final Map<String, Map<String, bool>> sportsCategoriesA = {
    'A.1 Combat Sports': {
      'Karate': false,
      'Taekwondo': false,
      'Judo': false,
    ...
    'A.6 Modern or Mixed': {'Parkour': false, 'Calisthenics': false},
  ...
  static final Map<String, Map<String, bool>> sportsCategoriesB = {
    'B.1 Ball Sports': {
      'Football': false,
      'Basketball': false,
      'Volleyball': false,
    ...
    'B.2 Team Water Sports': {'Water Polo': false, 'Aqua Football': false},
    'B.3 Group Artistic Sports': {
      'Group Gymnastics': false,
      'Group Dance': false,
    },
    'B.4 Winter Team Sports': {'Ice Hockey': false, 'Group Ski Racing': false},
  ...
  static List<String> getAllSports() {
    ...
    sportsCategories.forEach((_, subCategories) {
      subCategories.forEach((_, sportsMap) {
        allSports.addAll(sportsMap.keys);
      });
    });
    return allSports;
  }
